...
#define SETUP_COUNT_2ms     133
#define SETUP_COUNT_1ms_DIFF (SETUP_COUNT_2ms - SETUP_COUNT_1ms)
...
//SETUP_EXTERN unsigned short int SETUP_getDCRegVal(unsigned char percent);
